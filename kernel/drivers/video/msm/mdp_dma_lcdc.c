...
extern int lcdc_ta8566_panel_poweron(void);
extern void lcdc_ta8566_panel_poweroff(void);
#endif
...
#if defined(CONFIG_FB_MSM_LCDC_TA8566_WQVGA)
	/* 20100915
         LDI Power ON  (LDI must be turned on after lcdc power on)
         */
    lcdc_ta8566_panel_poweron(); // 20100915 
#endif
...
#if defined(CONFIG_FB_MSM_LCDC_TA8566_WQVGA)
	/* 20100915
         LDI Power Off  (LDI must be turned off before lcdc power off)
         */
